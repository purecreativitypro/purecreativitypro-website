  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-200 font-sans selection:bg-amber-500/30 selection:text-amber-100 relative overflow-x-hidden">
      ...
      <SocialProofBar
        accentColor="amber"
        stats={[
          { value: 8, suffix: '+', label: 'Free Guides' },
          { value: 500, suffix: '+', label: 'Downloads' },
          { value: 10, suffix: 'min', label: 'Avg. Read Time' },
        ]}
      />
      ...
      <div className="container mx-auto px-6 max-w-6xl py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'AI for Real Life', icon: <Cpu />, color: 'text-cyan-400', border: 'hover:border-cyan-500/50', bg: 'from-cyan-950/40', img: 'photo-1677442136019-21780ecad995' },
            { label: 'Media Basics', icon: <Aperture />, color: 'text-orange-400', border: 'hover:border-orange-500/50', bg: 'from-orange-950/40', img: 'photo-1611532736597-de2d4265fba3' },
            { label: 'Music Basics', icon: <Music />, color: 'text-fuchsia-400', border: 'hover:border-fuchsia-500/50', bg: 'from-fuchsia-950/40', img: 'photo-1493225457124-a3eb161ffa5f' },
            { label: 'Business Basics', icon: <BarChart3 />, color: 'text-emerald-400', border: 'hover:border-emerald-500/50', bg: 'from-emerald-950/40', img: 'photo-1552664730-d307ca884978' },
          ].map((item, i) => (
            <button
              key={i}
              onClick={() => scrollToSection('starter-kits')}
              className={`relative overflow-hidden p-6 rounded-2xl border border-neutral-800 transition-all duration-300 group ${item.border} min-h-[140px] text-left`}
            >
              <img
                src={`https://images.unsplash.com/${item.img}?q=30&w=400&auto=format&fit=crop`}
                alt=""
                loading="lazy"
                className="absolute inset-0 w-full h-full object-cover opacity-10 group-hover:opacity-20 transition-opacity"
              />
              <div className={`absolute inset-0 bg-gradient-to-t ${item.bg} to-neutral-950`} />
      ...
      {/* 3) FREE SECTION — Magazine Layout */}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="space-y-4">
              ...
              <FreeCard title="10 AI Prompts I Use Every Week" desc="Copy/paste prompts for real life + business." color="cyan" />
              <FreeCard title="AI Starter Workflow" desc="Notes → plan → output template you can reuse." color="cyan" />
            </div>
            ...
            <div className="space-y-4">
              ...
              <FreeCard title="Beginner Camera Buying Guide" desc="What to buy without overpaying (Kids Sports/Vlog)." color="orange" />
              <FreeCard title="Phone Video Checklist" desc="Lighting, framing, audio in one page." color="orange" />
            </div>
            ...
            <div className="space-y-4">
              ...
              <FreeCard title="Make Your First Track: 7 Steps" desc="From idea to export — beginner friendly." color="fuchsia" />
              <FreeCard title="10 Chord Progressions That Work" desc="A simple sheet to get unstuck." color="fuchsia" />
            </div>
            ...
            <div className="space-y-4">
              ...
              <FreeCard title="Pick Your Side Hustle in 30 Mins" desc="Worksheet to choose a direction fast." color="emerald" />
              <FreeCard title="Offer Builder Template" desc="Turn a skill into a sellable package." color="emerald" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          <PriceCard
            price="9"
            tier="Quick Starts"
            items={["AI Prompt Library (Expanded)", "Lightroom Presets (Mobile)", "Social Bio Templates"]}
            color="text-neutral-300"
          />

          <div className="relative transform md:-translate-y-4">
            <div className="absolute -top-10 left-0 right-0 text-center">
              <span className="bg-amber-500 text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide shadow-[0_0_20px_rgba(245,158,11,0.3)]">Best Value</span>
            </div>
            <PriceCard
              price="19"
              tier="Toolkits"
              highlight
              items={["The Content Calendar System", "OBS / Streaming Setup Guide", "Freelance Contract Template", "Client Email Scripts"]}
          ...
          <PriceCard
            price="47"
            tier="Mini Courses"
            items={["Business Launch Weekend", "Video Editing 101 (CapCut)", "Beatmaking for Beginners"]}
            color="text-white"
          />
        </div>
      </div>
      ...
      <div className="bg-neutral-900 border-t border-neutral-800 py-24">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5 bg-neutral-800 -z-10" />
            ...
            {[
              ...
              <ScrollReveal key={i} direction="up" delay={i * 0.1} distance={20}>
                <div className="flex flex-col items-center">
                  <div className="w-24 h-24 bg-neutral-950 border border-neutral-700 rounded-full flex flex-col items-center justify-center mb-6 shadow-xl relative z-10 hover:border-amber-500/50 transition-colors">
...
const FreeCard: React.FC<{ title: string; desc: string; color: string }> = ({ title, desc, color }) => {
  ...
  return (
    <a href="#" className={`block bg-neutral-950 border border-neutral-800 p-5 rounded-xl transition-all duration-300 group ${colorClasses[color]} hover:-translate-y-1`}>
      <div className="flex justify-between items-start mb-3">
        <BookOpen size={18} className="text-neutral-600 group-hover:text-white transition-colors" />
        <span className="text-[10px] font-bold uppercase tracking-wider bg-neutral-900 text-neutral-500 px-2 py-0.5 rounded group-hover:bg-white group-hover:text-black transition-colors">Free</span>
      </div>
      <h4 className="font-bold text-white mb-1 leading-tight text-sm">{title}</h4>
      <p className="text-neutral-500 text-xs leading-relaxed mb-3">{desc}</p>
